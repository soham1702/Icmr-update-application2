...
describe('InventoryType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'inventory-type', component: InventoryTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.inventoryTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
