...
describe('BedType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'bed-type', component: BedTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.bedTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
