...
describe('InventoryMaster Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'inventory-master', component: InventoryMasterComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.inventoryMasters?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
