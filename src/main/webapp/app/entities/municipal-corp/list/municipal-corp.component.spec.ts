...
describe('MunicipalCorp Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'municipal-corp', component: MunicipalCorpComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.municipalCorps?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
