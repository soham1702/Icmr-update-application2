...
describe('InventoryUsed Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'inventory-used', component: InventoryUsedComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.inventoryUseds?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
