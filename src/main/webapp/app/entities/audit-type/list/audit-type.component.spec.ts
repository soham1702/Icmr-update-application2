...
describe('AuditType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'audit-type', component: AuditTypeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.auditTypes?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
