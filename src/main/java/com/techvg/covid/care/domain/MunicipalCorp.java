...
public class MunicipalCorp implements Serializable {
    ...
    public MunicipalCorp id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public MunicipalCorp lastModified(Instant lastModified) {
    ...
    public MunicipalCorp lastModifiedBy(String lastModifiedBy) {
